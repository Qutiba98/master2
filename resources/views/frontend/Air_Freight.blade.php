...
.bradcam_bg_2 {
    background-image: url('/img/service/Air_Freight.jpg') !important; /* تغيير الصورة هنا */
}
...
.service_gallery {
    ...
    justify-content: center; /* لمحاذاة الصور في المنتصف أفقيًا */
}

.service_thumb {
    flex: 1; /* يجعل جميع العناصر بنفس العرض */
    max-width: 30%; /* يحدد العرض النسبي */
    height: 200px; /* يحدد نفس الطول لكل العناصر */
}

.service_thumb img {
    width: 100%; /* لجعل الصور تأخذ العرض الكامل للعنصر الأب */
    height: 100%; /* لجعل الصور تتناسب مع الطول */
    object-fit: cover; /* لضبط الصورة داخل العنصر بدون تشويه */
    border: 1px solid #ddd; /* لإضافة إطار خفيف حول الصورة */
}
                            ...
                            <div class="service_details_left">
                                ...
                                <div class="nav nav-pills" id="v-pills-tab" role="tablist"
                                    ...
                                    <a class=" active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home"
                                        role="tab" aria-controls="v-pills-home" aria-selected="true">Air Freight</a>
                                    ...
                                    <a class="" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages"
                                        role="tab" aria-controls="v-pills-messages" aria-selected="false">Land Transport</a>
                                </div>
                            </div>
                        </div>
...
<p>To consistently meet your freight deadlines, you need a global air freight provider that serves major business centres throughout the world.

</p>                                                                                

<p>
    We combine decades of experience, an expansive global network and a broad global air freight portfolio – all designed to deliver on your demanding supply chain needs.
                                    ...
                                    <div class="service_gallery">
                                        ...
                                        <div class="service_thumb">
                                            <img class="img-fluid" src="img/service/ww1.jpg" alt="">
                                        </div>
                                        <div class="service_thumb">
                                            <img class="img-fluid" src="img/service/ww2.jpg" alt="">
                                        </div>
                                    </div>
