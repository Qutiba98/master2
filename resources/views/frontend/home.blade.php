            ...
            <div class="row align-items-center">
                <div class="col-xl-7 col-md-6">
                    <div class="action_heading">
                        ...
                        <p>Guaranteed storage and shipping service</p>
                    </div>
                </div>
                ...
                <div class="row  align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="features_info">
                            ...
                            <ul>
                                <li> Maintain storage. </li>
                                <li> Safe shipping. </li>
                                <li> Storage in private warehouses.</li>
                            </ul>

                            <div class="about_btn">
                                <a class="boxed-btn3-line" href="{{ route('about') }}">About Us</a>
                            </div>
                        </div>
                    </div>
                </div>
